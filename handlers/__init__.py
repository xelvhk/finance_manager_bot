...
from handlers import start, finance, accumulations, tasks, shared
from states import SharedStates
from .start import cmd_start, month_chosen

def register_all_handlers(dp: Dispatcher):
    # Регистрация стартовых команд и колбэков
    dp.message.register(cmd_start, Command("start"))
    dp.callback_query.register(month_chosen, lambda c: c.data.startswith("month:"))
    ...
    # Обработчики совместного редактирования
    dp.message.register(shared.edit_shared_cmd, Command("edit_shared"))
    dp.message.register(shared.update_shared_data, SharedStates.waiting_for_shared_input)